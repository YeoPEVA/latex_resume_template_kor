...
\section{요약}
  \resumeSubHeadingListStart
    \resumeItem{보안 분석과 침해대응 절차를 함께 익혀온 정보보호 전공 학부생입니다.}
    \resumeItem{악성코드·익스플로잇 킷 연구, CTF, 공군 정보보호병 경험을 통해 분석과 운영 관점을 넓혀왔습니다.}
    \resumeItem{반복되는 분석·점검 업무를 도구와 자동화로 개선하는 데 관심이 있습니다.}
...
\section{교육}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{학점 3.73/4.5 (4-1 종료 기준)}
...
\section{대표 프로젝트 및 활동}
  \resumeSubHeadingListStart
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{Checkov·KICS·Trivy 스캐너와 MCP 기반 AI 에이전트를 결합한 IaC 감사 파트를 담당했고, 학술대회 논문 작성에 참여했습니다.}
      \resumeItemListEnd
    ...
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{금융보안아카데미 최우수상 수상. 팀으로 국제 CTF 3건 포함 8개 대회에 참가했고, 화이트햇 콘테스트 예선은 포렌식 파트를 맡아 대학생부 4위로 본선에 진출했습니다.}
      \resumeItemListEnd

    \resumeProject
      {디지털 포렌식 · 침해대응 경진대회 분석}
      {2022.12 -- 2025.12 / 디스크·로그 이미지에서 유입 경로와 실행 흔적을 추적하고 타임라인으로 재구성했습니다.}
      \resumeItemListStart
        \resumeItem{HCCC 2025 에서 Web Server 이미지 분석을 담당해 웹셸 명령 8건을 복원하고 cron 지속성까지 확인했습니다.}
      \resumeItemListEnd
    ...
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{analyzeMFT 기반 도구의 CLI to GUI 전환과 JSON 출력 개선을 담당했습니다.}
      \resumeItemListEnd
    ...
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{크롤러 3사·MySQL·ELK 구축을 담당했고, 검증된 사기 매물 101건에서 뽑은 패턴으로 판별 로직을 구성해 논문으로 확장했습니다.}
      \resumeItemListEnd
