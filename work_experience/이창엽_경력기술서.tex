  ...
  \resumeSubHeadingListStart
    ...
    \resumeProject
      ...
      \resumeItemListStart
        ...
        \resumeItem{금융보안아카데미 2025 최우수상(금융보안원장) 수상. 팀으로 국제 CTF 3건 포함 8개 대회에 참가했고, 화이트햇 콘테스트 예선은 포렌식 파트를 맡아 대학생부 4위로 본선에 진출했습니다.}
      \resumeItemListEnd
    ...
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{경진대회에 지속적으로 참여하며 로그·파일 아티팩트·시스템 이벤트로 침해사고 흐름을 분석했습니다. HCCC 2025 에서는 Web Server 이미지를 맡아 웹셸 명령 8건을 복원하고 cron 지속성을 확인했습니다.}
    ...
    \resumeProject
      ...
      \resumeItemListStart
        ...
        \resumeItem{CLI 전용이던 도구에 GUI 를 추가하고 JSON 출력을 개선해, MFT 분석 결과 확인과 파일시스템 기반 타임라인 재구성을 보조하도록 했습니다.}
      \resumeItemListEnd
    ...
    \resumeProject
      ...
      \resumeItemListStart
        \resumeItem{크롤러 3사·백엔드·ELK 구축을 담당했고, Logstash 대신 go-mysql-elasticsearch 로 동기화 속도를 개선했습니다.}
        \resumeItem{검증 사기 매물 101건에서 패턴을 뽑고, 비정상 가격은 3시그마 규칙으로 판별하도록 구현했습니다.}
        \resumeItem{결과를 KCI 등재 논문과 한국정보보호학회 동계학술대회 발표로 확장했고, BoB 9기 디지털포렌식 트랙 TOP 14 자문단 평가까지 진출했습니다.}
      \resumeItemListEnd
