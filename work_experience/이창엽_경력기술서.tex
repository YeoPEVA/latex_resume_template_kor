...
\section{주요 경험}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {2023.04 -- 현재}
      \resumeItemListStart
        \resumeItem{2023 -- 2026학년도 전공동아리 멘토로 연속 임명되어 학생 프로젝트를 지도하고 있으며, 2025.11.27 전공동아리 프로젝트 최종 발표회에서 12개 작품을 심사했습니다.}
...
\section{기술 및 관심 분야}
  \resumeSubHeadingListStart
    \resumeSkill{디지털 포렌식 · 침해대응 (DFIR)}{Windows Artifact(MFT, Registry, Prefetch, Event Log), 타임라인 재구성, 침해사고 분석, 분석 보고서 작성}
